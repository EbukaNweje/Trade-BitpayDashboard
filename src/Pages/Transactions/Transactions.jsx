...
const Transactions = () => {
    ...
    const url = `https://slim-new-site-back-end-two.vercel.app/api/getalldeposit/${id}`
    const url2 = `https://slim-new-site-back-end-two.vercel.app/api/getallwithdrawal/${id}`
